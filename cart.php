...
<body>
  ...
  <div class="container my-5">
    <div class="row g-4">
      ...
      <?php
      // Fetch all artworks
      $query = "SELECT * FROM tbl_items WHERE cart_id IS NOT NULL ORDER BY id DESC";
      ...
      ?>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card shadow-sm">
              ...
              <a href="deleteCart.php?id=<?php echo $row['id']; ?>" id="delete-icon"
              ...
              <div style="overflow: hidden;">
                <img src="<?php echo htmlspecialchars($row['image_url']); ?>" class="card-img-top zoom-img" alt="Artwork 1">
              </div>
              <div class="card-body">
